...
const INVENTORY_DRAIN_TICKET = 'inventory-v7-build-drain-20260813-a';
...
(async () => {
  const ticketKey = process.env.MJ_INVENTORY_BUILD_TICKET || 'inventory-v7-build-drain-20260813-a';
  ...
  const activeMs = Math.max(30000, Math.min(1800000, Number(claim.active_ms || 600000)));
