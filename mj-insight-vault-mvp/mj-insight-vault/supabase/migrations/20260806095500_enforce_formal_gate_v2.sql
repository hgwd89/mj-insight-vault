-- Require the raw-before-enrichment gate before a full-corpus report may be saved.
-- This intentionally blocks the old application build from persisting a false formal report.
