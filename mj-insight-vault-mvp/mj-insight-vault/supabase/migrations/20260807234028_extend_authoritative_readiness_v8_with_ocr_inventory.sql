...
cross join public.source_image_ingest_provenance_gate_v2 ip
...
create or replace view public.aaaa_pipeline_readiness_authoritative_v1
with (security_invoker=true)
as select * from public.aaaa_pipeline_readiness_v8;
revoke all on public.aaaa_pipeline_readiness_authoritative_v1 from public,anon,authenticated;
grant select on public.aaaa_pipeline_readiness_authoritative_v1 to service_role;