-- V21 adds top-to-bottom low-ink bands for extremely tall/narrow OCR blocks.
-- This changes only receipt provenance kinds; OCR consensus thresholds are unchanged.
...
begin
  ...
  return jsonb_build_object('status','stored','article_id',p_article_id,'pass_kind',p_pass_kind,'sequence',p_sequence,'segment_count',p_segment_count,'block_index',p_block_index,'piece_sequence',p_piece_sequence,'piece_count',p_piece_count,'piece_kind',p_piece_kind);
end
$function$;
