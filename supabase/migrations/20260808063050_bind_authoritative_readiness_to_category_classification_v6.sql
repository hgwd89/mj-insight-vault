...
select r.formal_article_count,r.source_capture_count,r.source_page_identity_count,r.page_identity_gate,r.formal_corpus_freeze_gate,r.formal_corpus_freeze_reason,
       ...
       r.valid_scan_count,r.valid_theme_proof_count,r.total_report_jobs_v6,r.queued_report_jobs_v6,r.running_report_jobs_v6,r.review_report_jobs_v6,r.completed_report_jobs_v6,r.published_report_jobs_v6,r.failed_report_jobs_v6,r.formal_v6_report_count,
       r.readiness_status,s.active_legacy_cron_count,s.orphan_legacy_active_job_count,s.legacy_formal_report_count,s.invalid_v6_formal_report_count,s.externally_executable_security_definer_count,s.strict_rls_disabled_table_count,s.strict_external_dml_grant_count,s.system_safety_gate,
       case when s.system_safety_gate<>'passed' then 'system_safety_gate_failed'
            ...
            else r.readiness_status end readiness_status_v8,
